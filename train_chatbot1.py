...
# ... (loading and preprocessing data as in the original code)
...
model.save('chatbot_model_lstm.h5', hist)
...
# ... (plotting training and validation performance as in the original code)
